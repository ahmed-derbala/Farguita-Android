...
public class MyCommentsAdapter extends RecyclerView.Adapter<MyCommentsAdapter.MyViewHolder> {
    ...
    public MyCommentsAdapter(ArrayList<Restaurant> myDataset) {
        mDataset = myDataset;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public MyCommentsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                             int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.myprofilecomments_card, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.mTelephone.setText(mDataset.get(position).getTelephone());
