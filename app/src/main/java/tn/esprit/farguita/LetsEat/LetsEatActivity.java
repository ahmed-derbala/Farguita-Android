...
import tn.esprit.farguita.LetsEat.Response.PlacesResponse;
import tn.esprit.farguita.LetsEat.Response.PlacesResponse.CustomA;
...
public class LetsEatActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
        ...
        dialog.setTitle("Enable Location")
                ...
                .setPositiveButton("Allow", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface paramDialogInterface, int paramInt) {
                        ...
                        ActivityCompat.requestPermissions(LetsEatActivity.this,
                                new String[]{ACCESS_COARSE_LOCATION,ACCESS_FINE_LOCATION},
                                MY_PERMISION_CODE);
    ...
    public void showSnack(boolean isConnected) {
        ...
        int color;
        if (isConnected) {
            message = "Good! Connected to Internet, Click Restaurant photo to get Navigations";
            color = Color.WHITE;
            getUserLocation();
        } else {
