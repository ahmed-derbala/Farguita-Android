package tn.esprit.farguita.Login;
...
import tn.esprit.farguita.Register.RegisterActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            ...
            Toast.makeText(getApplicationContext(),
                    "You already logged in !", Toast.LENGTH_LONG)
                    .show();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(name, email, uid, created_at,photo);
