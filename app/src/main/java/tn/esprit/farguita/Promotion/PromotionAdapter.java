package tn.esprit.farguita.Promotion;
...
import tn.esprit.farguita.Models.Promotion;
...
import static tn.esprit.farguita.app.AppConfig.URL_SERVER;
...
public class PromotionAdapter extends RecyclerView.Adapter<PromotionAdapter.MyViewHolder> {
    ...
    public PromotionAdapter(ArrayList<Promotion> myDataset) {
        mDataset = myDataset;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public PromotionAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                            int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        Picasso.with(p).load(URL_SERVER+"FarguitaServer/PromotionPhotos/"+mDataset.get(position).getPhoto()).into(holder.mPhoto);
        holder.mPlaceTitle.setText(mDataset.get(position).getPlaceTitle());
      //  holder.mAddress.setText(mDataset.get(position).get());
        holder.mPlaceType.setText(mDataset.get(position).getDescription());
       // holder.mTelephone.setText(mDataset.get(position).getPhoto());
