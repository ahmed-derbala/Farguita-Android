...
import tn.esprit.farguita.Main.MainActivity;
...
import static tn.esprit.farguita.app.AppConfig.URL_GET_PROMOTION;
...
public class PromotionFragment extends Fragment {
    ...
    RecyclerView rv;
    public static ArrayList<Promotion> DataAdapterClassList = new ArrayList<Promotion>();
    public static PromotionAdapter adapter = new PromotionAdapter(DataAdapterClassList);
...
//                                    Toast.makeText(MainActivity.this, mItems.get(position) + " swiped right", Toast.LENGTH_SHORT).show();
    ...
    private void getFavorisByUsername(final String username)
    {
        ...
        jsonArrayRequest = new JsonArrayPostRequest(URL_GET_PROMOTION,
                new Response.Listener<JSONArray>()
                {
                    ...
                    public void onResponse(JSONArray array) {
                        for(int i = 0; i<array.length(); i++) {
                            Promotion GetDataAdapter2 = new Promotion();
